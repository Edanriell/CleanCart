...
public class PaymentGatewayTests
{
    ...
    public async Task ProcessPaymentAsync_ReturnsPaymentResult()
    {
        ...
        var mockApiResponse = new ApiResponse<string>(new HttpResponseMessage(HttpStatusCode.Created), string.Empty,
            new RefitSettings());
    ...
    {
        var mockApi = Substitute.For<IPaymentGatewayApi>();
        var mockApiResponse = new ApiResponse<string>(new HttpResponseMessage(HttpStatusCode.OK), string.Empty,
            new RefitSettings());
